...
plots.Add('evtsel_tau1_et', '', 10,20,100, palette.green, 'fill', 'nothing', 'tau1_et', 0.001, False, False)
plots.Add('evtsel_Zll_m', '', 20,0, 250, palette.green, 'fill', 'nothing', 'Zll_m', 0.001, False, False)
...
#plots.Add('evtsel_sum_tau_pt', '', 11, 40, 250, palette.green, 'fill', 'nothing', 'sum_tau_pt', 0.001, False, False)
...
#plots.Add('evtsel_transmass_vlep1MET', '_totalTEST', 10, 0, 200, palette.green, 'fill', 'nothing', 'transmass_vlep1MET', 0.001, False, False)
...
plots.Add('evtsel_H_m_MMC', '', 10,0,350, palette.green, 'fill', 'nothing', 'H_m_MMC', 0.001, False, False)
...
#plots.Add('evtsel_M2T', '', 15, 20, 220, palette.green, 'fill', 'nothing', 'M2T', 1, False, False)
plots.Add('evtsel_vlep1_pt', '',10,20,150, palette.green, 'fill', 'nothing', 'vlep1_pt', 0.001, False, False)
...
#plots.Add('evtsel_vlep2_pt', '',10,20,150, palette.green, 'fill', 'nothing', 'vlep2_pt', 0.001, False, False)
plots.Add('evtsel_tau2_et', '', 10, 20, 100, palette.green, 'fill', 'nothing', 'tau2_et', 0.001, False, False)
