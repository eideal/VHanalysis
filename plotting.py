...
#plots.Add('evtsel_MET','_WHhh', 15, 0, 150, 'MET[GeV]', 0.001, False)
plots.Add('evtsel_dR','_WHhh', 1, 0, 3.2, 'dR(tau1,tau2)', 1, False) 
...
#plots.Add('evtsel_transmass_lep1MET', '_Jets', 25, 0, 250, 'evtsel_transmass_lep1MET', 0.001, False)
...
#plots.Add('evtsel_nLeptons', '_WHhh', 5,0,5, 'evtsel_nLeptons',1,False)
...
#plots.Add('evtsel_Zll_mass', '_WHhh', 20,0, 200, 'evtsel_Zll_mass', 0.001, False)
...
plots.Add('evtsel_vlep1_pt', '_WHhh',30,0,300, 'evtsel_vlep1_pt', 0.001, False)
...
#plots.Add('evtsel_H_m_vis', '_WHhh', 15,0,300, 'evtsel_H_m_vis', 0.001, False)
...
#plots.Add('evtsel_lep1_pt', 'WHhh', 40, 0, 200, 'evtsel_lep1_pt', 0.001, False)
...
#plots.Add('evtsel_tau1_phi', '_WHhh', 15,-4,8, 'evtsel_tau1_phi', 1, False)
...
#plots.Add('evtsel_tau1_eta', '_WHhh', 15,-3.5,6, 'evtsel_tau1_eta', 1, False)
