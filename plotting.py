...
plots.Add('evtsel_MET','_total', 30, 0, 300, 'evtsel_MET', 0.001, False)
...
#plots.Add('evtsel_sum_tau_pt', '_WHhh', 60, 0, 300, 'evtsel_sum_tau_pt', 0.001, False)
#plots.Add('evtsel_sum_lep_pt', '_WHhh', 60, 0, 300, 'evtsel_sum_lep_pt', 0.001, False)
...
plots.Add('evtsel_transmass_lep1MET', '_total', 30, 0, 300, 'evtsel_transmass_lep1MET', 0.001, False)
...
#plots.Add('evtsel_tau2_et', '_WHhh', 40, 0, 200, 'evtsel_tau2_et', 0.001, False)
