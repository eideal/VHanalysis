...
plots.Add('evtsel_tau1_et', '', 10,20,100, palette.green, 'fill', 'nothing', 'E_{T}^{#tau_{1}}', 0.001, False, False)
plots.Add('evtsel_Zll_m', '', 20,0, 250, palette.green, 'fill', 'nothing', 'M_{ll}', 0.001, False, False)
plots.Add('evtsel_dR','_totalTEST', 20, 0, 8, palette.green, 'fill', 'nothing', '#DeltaR(#tau_{1},#tau_{2})', 1, False, False)
#plots.Add('evtsel_V_pt','_totalTEST', 20, 0, 200, palette.green, 'fill','nothing', 'V_pt', 0.001, False, False)
plots.Add('evtsel_sum_tau_pt', '', 11, 40, 250, palette.green, 'fill', 'nothing', '#Sigma(E_{T}^{#tau_{1}} + E_{T}^{#tau_{2}})', 0.001, False, False)
...
plots.Add('evtsel_transmass_vlep1MET', '_totalTEST', 10, 0, 200, palette.green, 'fill', 'nothing', 'm_{T}(vlep_{1}, MET)', 0.001, False, False)
...
plots.Add('evtsel_MET','', 12, 0, 150, palette.green, 'fill','nothing', 'MET', 0.001, False, False)
...
#plots.Add('evtsel_nLeptons', '', 1,0,10, palette.green, 'fill', 'nothing', 'nLeptons',1,False, False)
#plots.Add('evtsel_MET_phi', '_total', 15, -math.pi, 2*math.pi, palette.green, 'fill', 'nothing', 'MET_phi', 1, False, False)

plots.Add('evtsel_H_m_MMC', '', 10,0,350, palette.green, 'fill', 'nothing', 'm_{MMC}', 0.001, False, False)
plots.Add('evtsel_H_m_MMC', '_totalTEST', 5,25,225, palette.green, 'fill', 'nothing', 'm_{MMC}', 0.001, False, False)
plots.Add('evtsel_H_m_MMC', '_totalTEST', 5,25,225, palette.green, 'fill', 'nothing', 'm_{MMC}', 0.001, False, True)
plots.Add('evtsel_H_m_MMC', '_totalTEST', 1,25,225, 'm_{MMC}', 0.001, False, True)
plots.Add('evtsel_M2T', '_totalTEST', 8, 25, 200, palette.green, 'fill', 'nothing', 'M_{2T}', 1, False, True)
plots.Add('evtsel_M2T', '', 15, 20, 220, palette.green, 'fill', 'nothing', 'M_{2T}', 1, False, False)
plots.Add('evtsel_vlep1_pt', '',10,20,150, palette.green, 'fill', 'nothing', 'p_{T}^{l_{1}}', 0.001, False, False)
...
plots.Add('evtsel_tau2_et', '', 10, 20, 100, palette.green, 'fill', 'nothing', 'E_{T}^{#tau_{1}}', 0.001, False, False)
